# -*- coding: utf-8 -*-
# Part of OdooChain. See LICENSE file for full copyright and licensing details.
...
# 需要安装python包: pip3 install bigchaindb_driver==0.6.2,windows 需要选择安装vs build tools 2022 workload 第一项 大概6G

# https://docs.bigchaindb.com/projects/py-driver/en/v0.6.2/index.html
