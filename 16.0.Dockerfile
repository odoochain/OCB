...
RUN set -x; \
        ...
        # PyYAML required by custom scripts for adding modules (https://github.com/odoochain/chain_docker_odoo/tree/main/templates)
...
RUN set -x; \
        ...
        find /opt/odoo/odoo/addons/*/i18n/ /opt/odoo/odoo/odoo/addons/base/i18n/ -type f -not -name 'zh_CN.po' -delete &&\
...
LABEL org.label-schema.schema-version="16.0-chain" \
      org.label-schema.vendor=OdooChain \
      org.label-schema.license=Apache-2.0 \
      org.label-schema.vcs-url="https://github.com/odoochain/odoochain-docker"
